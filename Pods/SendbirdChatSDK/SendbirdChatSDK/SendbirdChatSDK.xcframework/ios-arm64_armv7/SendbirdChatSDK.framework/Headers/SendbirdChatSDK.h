...
#ifndef SENDBIRDCHATSDK_SWIFT_H
#define SENDBIRDCHATSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SendbirdChatSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Identifier for the message conforming to <code>Identifiable</code>
@property (nonatomic, readonly, copy) NSObject * _Nonnull id;
...
/// since:
/// 4.0.0
@property (nonatomic, strong) SBDScheduledInfo * _Nullable scheduledInfo;
...
@property (nonatomic, copy) NSString * _Nullable channelUrl SWIFT_UNAVAILABLE_MSG("'channelUrl' has been renamed to 'channelURL'");
...
@property (nonatomic, copy) NSString * _Nonnull parentMessageText SWIFT_UNAVAILABLE_MSG("This property has been removed.");
...
@property (nonatomic, strong) SBDMessageMetaArray * _Nullable metaArray SWIFT_UNAVAILABLE_MSG("Use `metaArrays` instead.");
...
@property (nonatomic, copy) NSString * _Nullable mentionedMessageTemplate;
...
SWIFT_PROTOCOL_NAMED("UserListQuery")
@protocol SBDUserListQuery
...
@interface SBDApplicationUserListQuery : NSObject <SBDUserListQuery>
...
@interface SBDApplicationUserListQuery (SWIFT_EXTENSION(SendbirdChatSDK))
...
///
- (void)setMetaDataFilterWithKey:(NSString * _Nullable)key values:(NSArray<NSString *> * _Nullable)values SWIFT_UNAVAILABLE_MSG("Use `ApplicationUserListQueryParams`'s `setMetaDataFilter`");
@end
...
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable userIdsFilter;
...
/// since:
/// 3.0.223
@property (nonatomic, readonly, copy) NSString * _Nullable nicknameStartsWithFilter;
@end


SWIFT_CLASS_NAMED("ApplicationUserListQueryParams")
@interface SBDApplicationUserListQueryParams : NSObject
/// Sets the user IDs filter.
...
/// \param builder The builder closure.
///
///
/// returns:
/// An initialized params object.
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDApplicationUserListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
/// Sets meta data filter.
/// \param key The key of the meta data to use for filter.
///
/// \param values The values of the meta data to use for filter.
...
@interface SBDApplicationUserListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDApplicationUserListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
/// \param completionHandler completion handler
///
- (void)loadNextPageWithCompletionHandler:(void (^ _Nonnull)(NSArray<SBDRestrictedUser *> * _Nullable, SBError * _Nullable))completionHandler;
/// Copies this object
/// \param zone optional <code>NSZone</code>
///
///
...
@interface SBDBannedUserListQuery (SWIFT_EXTENSION(SendbirdChatSDK))
/// Specifies the number of results to return per call. (Default: 20)
@property (nonatomic, readonly) NSUInteger limit;
@end


SWIFT_CLASS_NAMED("BannedUserListQueryParams")
@interface SBDBannedUserListQueryParams : NSObject
/// Specifies the number of results to return per call. (Default: 20)
@property (nonatomic) NSUInteger limit;
/// Default constructor.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
/// returns:
/// An initialized params object.
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDBannedUserListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end


@interface SBDBannedUserListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDBannedUserListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
/// Identifier for the channel conforming to <code>Identifiable</code>
...
SWIFT_PROTOCOL("_TtP15SendbirdChatSDK12Serializable_")
...
@interface SBDBaseChannel (SWIFT_EXTENSION(SendbirdChatSDK)) <Serializable>
...
SWIFT_PROTOCOL("_TtP15SendbirdChatSDK8Mappable_")
@protocol Mappable
...
@interface SBDBaseChannel (SWIFT_EXTENSION(SendbirdChatSDK)) <Mappable>
...
- (SBDUserMessage * _Nonnull)sendUserMessageWithParams:(SBDUserMessageCreateParams * _Nonnull)params requestId:(NSString * _Nullable)requestId completionHandler:(void (^ _Nullable)(SBDUserMessage * _Nullable, SBError * _Nullable))completionHandler SWIFT_WARN_UNUSED_RESULT;
...
/// note:
/// Only accpets messages whose <code>sendingStatus</code> is <code>.succeeded</code>.
...
- (SBDUserMessage * _Nullable)copyUserMessage:(SBDUserMessage * _Nonnull)message toTargetChannel:(SBDBaseChannel * _Nonnull)targetChannel completionHandler:(void (^ _Nullable)(SBDUserMessage * _Nullable, SBError * _Nullable))completionHandler;
...
@class SBDMutedUserListQueryParams;
@class SBDPreviousMessageListQuery;
@class SBDPreviousMessageListQueryParams;
@class SBDOperatorListQuery;
@class SBDOperatorListQueryParams;
...
/// since:
/// 4.0.1
/// \param paramsBuilder The builder closure for setting <code>BannedUserListQueryParams</code>.
///
///
/// returns:
/// The instance for the banned user list. Query only banned user list.
- (SBDBannedUserListQuery * _Nullable)createBannedUserListQueryWithParamsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDBannedUserListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates a query instance for banned user list of the channel.
/// since:
/// 3.0.89
/// \param params <code>BannedUserListQueryParams</code> instance.
///
///
/// returns:
/// The instance for the banned user list. Query only banned user list.
- (SBDBannedUserListQuery * _Nullable)createBannedUserListQueryWithParams:(SBDBannedUserListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
/// Creates a query instance for banned user list of the channel.
/// since:
/// 4.0.0
...
/// returns:
/// The instance for the banned user list. Query only banned user list.
+ (SBDBannedUserListQuery * _Nonnull)createBannedUserListQueryWithChannelType:(enum SBDChannelType)channelType channelURL:(NSString * _Nonnull)channelURL paramsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDBannedUserListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates a query instance for banned user list of the channel.
/// since:
/// 4.0.0
/// \param channelType The Type of channel, types of open channel or group channel.
...
/// returns:
/// The instance for the banned user list. Query only banned user list.
+ (SBDBannedUserListQuery * _Nonnull)createBannedUserListQueryWithChannelType:(enum SBDChannelType)channelType channelURL:(NSString * _Nonnull)channelURL params:(SBDBannedUserListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
...
/// Creates a query instance for getting muted user list of the channel instance.
/// \param paramsBuilder The builder closure for setting <code>MutedUserListQueryParams</code>.
///
///
/// returns:
/// UserListQuery instance for the muted user list.
- (SBDMutedUserListQuery * _Nullable)createMutedUserListQueryWithParamsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDMutedUserListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates a query instance for getting muted user list of the channel instance.
/// \param params The params object to change query condition.
///
///
/// returns:
/// UserListQuery instance for the muted user list.
- (SBDMutedUserListQuery * _Nullable)createMutedUserListQueryWithParams:(SBDMutedUserListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
/// Creates a query instance for getting muted user list of the channel instance.
/// since:
/// 4.0.0
/// \param channelType The Type of channel, types of open channel or group channel.
...
/// returns:
/// UserListQuery instance for the muted user list.
+ (SBDMutedUserListQuery * _Nonnull)createMutedUserListQueryWithChannelType:(enum SBDChannelType)channelType channelURL:(NSString * _Nonnull)channelURL paramsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDMutedUserListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates a query instance for getting muted user list of the channel instance.
/// since:
/// 4.0.0
/// \param channelType The Type of channel, types of open channel or group channel.
...
/// returns:
/// UserListQuery instance for the muted user list.
+ (SBDMutedUserListQuery * _Nonnull)createMutedUserListQueryWithChannelType:(enum SBDChannelType)channelType channelURL:(NSString * _Nonnull)channelURL params:(SBDMutedUserListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
...
/// Creates <code>PreviousMessageListQuery</code> instance for getting the previous messages list of the channel.
/// \param paramsBuilder The builder closure for setting <code>PreviousMessageListQueryParams</code>.
///
///
/// returns:
/// Returns the message list of the channel.
- (SBDPreviousMessageListQuery * _Nullable)createPreviousMessageListQueryWithParamsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDPreviousMessageListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates <code>PreviousMessageListQuery</code> instance for getting the previous messages list of the channel.
/// \param params The params object to change query condition.
///
///
/// returns:
/// Returns the message list of the channel.
- (SBDPreviousMessageListQuery * _Nullable)createPreviousMessageListQueryWithParams:(SBDPreviousMessageListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
/// Creates <code>PreviousMessageListQuery</code> instance for getting the previous messages list of the channel.
/// since:
/// 4.0.0
...
/// \param channelURL channel url
///
/// \param paramsBuilder The builder closure for setting <code>ParticipantListQueryParams</code>.
///
///
/// returns:
/// Returns the message list of the channel.
+ (SBDPreviousMessageListQuery * _Nonnull)createPreviousMessageListQueryWithChannelType:(enum SBDChannelType)channelType channelURL:(NSString * _Nonnull)channelURL paramsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDPreviousMessageListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates <code>PreviousMessageListQuery</code> instance for getting the previous messages list of the channel.
/// since:
/// 4.0.0
/// \param channelType channel type
...
/// returns:
/// Returns the message list of the channel.
+ (SBDPreviousMessageListQuery * _Nonnull)createPreviousMessageListQueryWithChannelType:(enum SBDChannelType)channelType channelURL:(NSString * _Nonnull)channelURL params:(SBDPreviousMessageListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// The operator list in the channel.
- (SBDOperatorListQuery * _Nullable)createOperatorListQueryWithParamsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDOperatorListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates <code>OperatorListQuery</code> instance for getting operators in the channel.
/// since:
/// 4.0.0
/// \param params The params object to change query condition.
...
/// returns:
/// The operator list in the channel.
- (SBDOperatorListQuery * _Nullable)createOperatorListQueryWithParams:(SBDOperatorListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
/// Creates <code>OperatorListQuery</code> instance for getting operators in the channel.
/// since:
/// 4.0.0
/// \param channelType The Type of channel, types of open channel or group channel.
...
/// \param channelURL The channel URL.
///
/// \param paramsBuilder The builder closure for setting <code>OperatorListQueryParams</code>.
///
///
/// returns:
/// The operator list in the channel.
+ (SBDOperatorListQuery * _Nonnull)createOperatorListQueryWithChannelType:(enum SBDChannelType)channelType channelURL:(NSString * _Nonnull)channelURL paramsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDOperatorListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates <code>OperatorListQuery</code> instance for getting operators in the channel.
/// since:
/// 4.0.0
/// \param channelType The Type of channel, types of open channel or group channel.
...
/// returns:
/// The operator list in the channel.
+ (SBDOperatorListQuery * _Nonnull)createOperatorListQueryWithChannelType:(enum SBDChannelType)channelType channelURL:(NSString * _Nonnull)channelURL params:(SBDOperatorListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
...
/// since:
/// 4.0.0
/// \param channelType Channel type of the channel URL.
///
...
/// returns:
/// poll list query object.
+ (SBDPollListQuery * _Nonnull)createPollListQueryWithChannelType:(enum SBDChannelType)channelType channelURL:(NSString * _Nonnull)channelURL SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// poll voter list query object.
+ (SBDPollVoterListQuery * _Nonnull)createPollVoterListQueryWithPollId:(int64_t)pollId optionId:(int64_t)optionId channelType:(enum SBDChannelType)channelType channelURL:(NSString * _Nonnull)channelURL SWIFT_WARN_UNUSED_RESULT;
@end
...
@protocol SBDBaseChannelDelegate
@optional
...
- (nonnull instancetype)copyWithFailedState SWIFT_WARN_UNUSED_RESULT;
/// Copies this message with fail state
...
/// returns:
/// copied object with error code
- (nonnull instancetype)copyWithFailedStateWithErrorCode:(NSInteger)errorCode SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDBaseMessage (SWIFT_EXTENSION(SendbirdChatSDK)) <Serializable>
/// Serializes this object into data
///
/// returns:
/// optioanal <code>Data</code> instance
...
@class SBDScheduledMessageRetrievalParams;
...
/// since:
/// 4.0.0
/// \param params The instance of <code>ScheduledMessageRetrievalParams</code> that can has parameters
/// related with scheduled message.
///
/// \param completionHandler The handler block to be executed after the message is registered in the schedule.
...
/// error made when there is something wrong to message.
///
+ (void)getScheduledMessageWithParams:(SBDScheduledMessageRetrievalParams * _Nonnull)params completionHandler:(void (^ _Nullable)(SBDBaseMessage * _Nullable, SBError * _Nullable))completionHandler;
@end
...
@interface SBDBaseMessageCreateParams : NSObject <NSCopying>
...
/// 3.0.103
@property (nonatomic) enum SBDMentionType mentionType;
/// Mention to specific users with user IDs.
...
/// since:
/// 4.0.0
@property (nonatomic, copy) NSArray<SBDUser *> * _Nullable mentionedUsers;
...
SWIFT_CLASS("_TtC15SendbirdChatSDK10BinaryData")
...
@interface SBDBlockedUserListQuery : NSObject <SBDUserListQuery>
/// Boolean indicates there are more data to fetch.
@property (nonatomic) BOOL hasNext;
/// Indicates the query is currently loading or not.
@property (nonatomic) BOOL isLoading;
...
@interface SBDBlockedUserListQuery (SWIFT_EXTENSION(SendbirdChatSDK))
/// Sets the user IDs filter.
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable userIdsFilter;
/// Specifies the number of results to return per call. (Default: 20)
@property (nonatomic, readonly) NSUInteger limit;
...
SWIFT_CLASS_NAMED("BlockedUserListQueryParams")
@interface SBDBlockedUserListQueryParams : NSObject
/// Sets the user IDs filter.
...
/// returns:
/// An initialized params object.
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDBlockedUserListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end


@interface SBDBlockedUserListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDBlockedUserListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC15SendbirdChatSDK17BlockingOperation")
...
/// since:
/// 3.1.0
SWIFT_PROTOCOL("_TtP15SendbirdChatSDK20ChannelEventDelegate_")
@protocol ChannelEventDelegate
@optional
...
///
- (void)channel:(SBDBaseChannel * _Nonnull)channel new:(SBDBaseMessage * _Nullable)new_;
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC15SendbirdChatSDK17ChannelRepository")
...
static NSString * _Nonnull const SBChatErrorDomain = @"SendbirdChatSDK.ChatError";


SWIFT_CLASS("_TtC15SendbirdChatSDK18ChatLoggerObserver")
@interface ChatLoggerObserver : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
static NSString * _Nonnull const SBCoreErrorDomain = @"SendbirdChatSDK.CoreError";
...
@interface SBDEmoji (SWIFT_EXTENSION(SendbirdChatSDK)) <Serializable>
/// Serializes this object into data
///
/// returns:
/// optioanal <code>Data</code> instance
...
@interface SBDEmojiCategory (SWIFT_EXTENSION(SendbirdChatSDK)) <Serializable>
/// Serializes this object into data
///
/// returns:
/// optioanal <code>Data</code> instance
...
@interface SBDEmojiCategory (SWIFT_EXTENSION(SendbirdChatSDK)) <Mappable>
/// Initialize with json dictionary
- (nullable instancetype)initWithDictionary:(NSDictionary<NSString *, id> * _Nonnull)json SWIFT_METHOD_FAMILY(none) SWIFT_WARN_UNUSED_RESULT;
/// Converts the object into dictionary
- (NSDictionary<NSString *, id> * _Nonnull)_toDictionary SWIFT_WARN_UNUSED_RESULT;
...
@interface SBDEmojiContainer (SWIFT_EXTENSION(SendbirdChatSDK)) <Serializable>
/// Serializes this object into data
///
/// returns:
/// optioanal <code>Data</code> instance
...
@property (nonatomic, copy) NSString * _Nullable plainUrl SWIFT_UNAVAILABLE_MSG("'plainUrl' has been renamed to 'plainURL'");
...
@interface SBDFileMessage (SWIFT_EXTENSION(SendbirdChatSDK))
/// Compares this object with given other object.
/// \param object <code>Any</code> instance
///
///
...
SWIFT_CLASS("_TtC15SendbirdChatSDK16FoundationStream")
...
@interface SBDFriendListQuery : NSObject <SBDUserListQuery>
/// Boolean indicates there are more data to fetch
@property (nonatomic) BOOL hasNext;
/// Indicates the query is currently loading or not
@property (nonatomic) BOOL isLoading;
...
@interface SBDFriendListQuery (SWIFT_EXTENSION(SendbirdChatSDK))
/// Specifies the number of results to return per call. (Default: 20)
@property (nonatomic, readonly) NSUInteger limit;
@end


SWIFT_CLASS_NAMED("FriendListQueryParams")
@interface SBDFriendListQueryParams : NSObject
/// Specifies the number of results to return per call. (Default: 20)
@property (nonatomic) NSUInteger limit;
/// Default constructor.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// Initializes and returns a newly allocated params object that mutated through builder closure.
/// \param builder The builder closure for mutating params.
///
///
/// returns:
/// An initialized params object.
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDFriendListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end


@interface SBDFriendListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDFriendListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
@class SBDScheduledUserMessageUpdateParams;
...
/// since:
/// 4.0.2
/// \param params The instance of <code>ScheduledUserMessageCreateParams</code> that can has parameters
/// related with string message.
///
/// \param completionHandler The handler block to be executed after the message is registered in the schedule.
/// This block has no return value and takes two argument, one is a user message is registered in the schedule and other is an
/// error made when there is something wrong to message.
///
- (SBDUserMessage * _Nullable)createScheduledUserMessageWithParams:(SBDScheduledUserMessageCreateParams * _Nonnull)params completionHandler:(void (^ _Nullable)(SBDUserMessage * _Nullable, SBError * _Nullable))completionHandler;
...
///
/// \param params The instance of <code>ScheduledUserMessageUpdateParams</code> that can has parameters
/// related with string message.
///
/// \param completionHandler The handler block to be executed after the message is registered in the schedule.
/// This block has no return value and takes two argument, one is a user message is registered in the schedule and other is an
...
/// \param scheduledMessageId The scheduled message ID.
///
/// \param params The instance of <code>ScheduledFileMessageUpdateParams</code> that can has parameters
/// related with file message.
///
/// \param completionHandler The handler block to be executed after the message is registered in the schedule.
/// This block has no return value and takes two argument, one is a user message is registered in the schedule and other is an
/// error made when there is something wrong to message.
///
- (void)updateScheduledFileMessageWithScheduledMessageId:(int64_t)scheduledMessageId params:(SBDScheduledFileMessageUpdateParams * _Nonnull)params completionHandler:(void (^ _Nullable)(SBDFileMessage * _Nullable, SBError * _Nullable))completionHandler;
@end



@class SBDScheduledFileMessageCreateParams;
...
/// since:
/// 4.0.0
/// \param params The instance of <code>ScheduledFileMessageCreateParams</code> that can has parameters
/// related with file message.
///
/// \param completionHandler The handler block to be executed after the message is registered in the schedule.
/// This block has no return value and takes two argument, one is a user message is registered in the schedule and other is an
/// error made when there is something wrong to message.
///
- (SBDFileMessage * _Nullable)createScheduledFileMessageWithParams:(SBDScheduledFileMessageCreateParams * _Nonnull)params completionHandler:(void (^ _Nullable)(SBDFileMessage * _Nullable, SBError * _Nullable))completionHandler;
@end
...
@class SBDGroupChannelListQueryParams;
@class SBDPublicGroupChannelListQuery;
@class SBDPublicGroupChannelListQueryParams;
@class SBDMemberListQuery;
@class SBDMemberListQueryParams;
...
/// returns:
/// GroupChannelListQuery instance for the current user.
+ (SBDGroupChannelListQuery * _Nonnull)createMyGroupChannelListQueryWithParamsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDGroupChannelListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates a query for my group channel list.
/// \param params <code>GroupChannelListQueryParams</code>
///
///
/// returns:
/// GroupChannelListQuery instance for the current user.
+ (SBDGroupChannelListQuery * _Nonnull)createMyGroupChannelListQueryWithParams:(SBDGroupChannelListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
...
/// Creates a query for public group channel list.
/// \param paramsBuilder The builder closure for setting <code>PublicGroupChannelListQueryParams</code>.
///
///
/// returns:
/// The instance to query public group channels.
+ (SBDPublicGroupChannelListQuery * _Nonnull)createPublicGroupChannelListQueryWithParamsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDPublicGroupChannelListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates a query for public group channel list.
/// \param params The params object to change query condition.
///
///
/// returns:
/// The instance to query public group channels.
+ (SBDPublicGroupChannelListQuery * _Nonnull)createPublicGroupChannelListQueryWithParams:(SBDPublicGroupChannelListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
...
+ (SBDMemberListQuery * _Nonnull)createMemberListQueryWithChannelURL:(NSString * _Nonnull)channelURL SWIFT_WARN_UNUSED_RESULT;
/// Creates a query for members in group channel.
/// \param channelURL channel url
///
/// \param paramsBuilder The builder closure for setting <code>MemberListQueryParams</code>.
///
///
/// returns:
/// The instance to query the members in group channel.
+ (SBDMemberListQuery * _Nonnull)createMemberListQueryWithChannelURL:(NSString * _Nonnull)channelURL paramsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDMemberListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates a query for members in group channel.
/// \param channelURL channel url
///
/// \param params The params object to change query condition.
...
/// returns:
/// The instance to query the members in group channel.
+ (SBDMemberListQuery * _Nonnull)createMemberListQueryWithChannelURL:(NSString * _Nonnull)channelURL params:(SBDMemberListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
/// Creates a query for members in group channel.
/// \param params The params object to change query condition.
///
///
/// returns:
/// The instance to query the members in group channel.
- (SBDMemberListQuery * _Nullable)createMemberListQuery SWIFT_WARN_UNUSED_RESULT;
/// Creates a query for members in group channel.
/// \param paramsBuilder The builder closure for setting <code>MemberListQueryParams</code>.
///
///
/// returns:
/// The instance to query the members in group channel.
- (SBDMemberListQuery * _Nullable)createMemberListQueryWithParamsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDMemberListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates a query for members in group channel.
/// \param params The params object to change query condition.
///
///
/// returns:
/// The instance to query the members in group channel.
- (SBDMemberListQuery * _Nullable)createMemberListQueryWithParams:(SBDMemberListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
@end
...
/// since:
/// 4.0.9
/// \param shouldRemoveOperatorStatus Set to true if you want the operator to remove the state when they leaves. Default is <code>false</code>
///
/// \param completionHandler The handler block to execute.
///
- (void)leaveChannelWithShouldRemoveOperatorStatus:(BOOL)shouldRemoveOperatorStatus completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler;
...
@interface SBDGroupChannel (SWIFT_EXTENSION(SendbirdChatSDK))
@property (nonatomic) BOOL sendMarkAsReadEnable SWIFT_UNAVAILABLE_MSG("`sendMarkAsReadEnable` has been removed.");
@property (nonatomic) BOOL isPushEnabled SWIFT_UNAVAILABLE_MSG("`isPushEnabled` has been removed.");
- (void)getChannelFromCacheWithChannelUrl:(NSString * _Nonnull)withChannelUrl SWIFT_UNAVAILABLE_MSG("`getChannelFromCache(withChannelUrl:)` has been removed.");
- (void)getReadReceiptOf:(SBDBaseMessage * _Nonnull)of SWIFT_UNAVAILABLE_MSG("`getReadReceipt(of:)` has been removed.");
+ (void)createChannelWithName:(NSString * _Nullable)name isDistinct:(BOOL)isDistinct userIds:(NSArray<NSString *> * _Nonnull)userIds coverImage:(NSData * _Nonnull)coverImage coverImageName:(NSString * _Nonnull)coverImageName data:(NSString * _Nullable)data customType:(NSString * _Nullable)customType progressHandler:(void (^ _Nullable)(int64_t, int64_t, int64_t))progressHandler completionHandler:(void (^ _Nonnull)(SBDGroupChannel * _Nullable, SBError * _Nullable))completionHandler SWIFT_UNAVAILABLE_MSG("'createChannel' has been renamed to 'createChannelWithParams:progressHandler:completionHandler:'");
- (void)updateWithName:(NSString * _Nullable)name isDistinct:(BOOL)isDistinct coverImage:(NSData * _Nullable)coverImage coverImageName:(NSString * _Nullable)coverImageName data:(NSString * _Nullable)data customType:(NSString * _Nullable)customType progressHandler:(void (^ _Nullable)(int64_t, int64_t, int64_t))progressHandler completionHandler:(void (^ _Nonnull)(SBDGroupChannel * _Nullable, SBError * _Nullable))completionHandler SWIFT_UNAVAILABLE_MSG("'update' has been renamed to 'updateChannelWithParams:progressHandler:completionHandler:'");
- (void)hideWithHidePreviousMessages:(BOOL)hidePreviousMessages completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler SWIFT_UNAVAILABLE_MSG("'hide' has been renamed to 'hideChannelWithHidePreviousMessages:completionHandler:'");
- (int64_t)getLastSeenAtBy:(SBDUser * _Nonnull)by SWIFT_WARN_UNUSED_RESULT SWIFT_UNAVAILABLE_MSG("'getLastSeenAt' has been renamed to 'getReadMembersWithMessage:includeAllMembers:'");
- (int64_t)getLastSeenAtByUserId:(SBDUser * _Nonnull)byUserId SWIFT_WARN_UNUSED_RESULT SWIFT_UNAVAILABLE_MSG("'getLastSeenAt' has been renamed to 'getReadMembersWithMessage:includeAllMembers:'");
- (NSInteger)getDeliveryReceipt SWIFT_WARN_UNUSED_RESULT SWIFT_UNAVAILABLE_MSG("'getDeliveryReceipt' has been renamed to 'getUndeliveredMemberCount:'");
- (NSArray<SBDUser *> * _Nonnull)getTypingMembers SWIFT_WARN_UNUSED_RESULT SWIFT_UNAVAILABLE_MSG("'getTypingMembers' has been renamed to 'getTypingUsers'");
- (void)setPushPreferenceWithPushOn:(BOOL)_ completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler SWIFT_UNAVAILABLE_MSG("`setPushPreferenceWithPushOn(_:completionHandler:)` has been removed.");
+ (void)getTotalUnreadMessageCountWithCompletionHandler:(void (^ _Nullable)(NSUInteger, SBError * _Nonnull))completionHandler SWIFT_UNAVAILABLE_MSG("Use `SendbirdChat.getTotalUnreadMessageCount(completionHandler:)` instead.");
+ (void)getTotalUnreadMessageCountWith:(SBDGroupChannelTotalUnreadChannelCountParams * _Nonnull)with completionHandler:(void (^ _Nullable)(NSUInteger, SBError * _Nonnull))completionHandler SWIFT_UNAVAILABLE_MSG("Use `SendbirdChat.getTotalUnreadMessageCount(params:completionHandler:)` instead.");
+ (void)getTotalUnreadMessageCountWithChannelCustomTypes:(NSArray<NSString *> * _Nullable)withChannelCustomTypes completionHandler:(void (^ _Nullable)(NSUInteger, SBError * _Nonnull))completionHandler SWIFT_UNAVAILABLE_MSG("Use `SendbirdChat.getTotalUnreadMessageCount(params:completionHandler:)` instead.");
@end
...
@interface SBDGroupChannelCollection (SWIFT_EXTENSION(SendbirdChatSDK)) <ChannelEventDelegate>
- (void)channel:(SBDBaseChannel * _Nonnull)channel new:(SBDBaseMessage * _Nullable)new_;
@end


@interface SBDGroupChannelCollection (SWIFT_EXTENSION(SendbirdChatSDK)) <SBDConnectionDelegate>
- (void)didSucceedReconnection;
- (void)didConnectWithUserId:(NSString * _Nonnull)userId;
@end
...
@interface SBDGroupChannelCollection (SWIFT_EXTENSION(SendbirdChatSDK)) <SBDGroupChannelDelegate>
- (void)channel:(SBDBaseChannel * _Nonnull)channel didReceiveMessage:(SBDBaseMessage * _Nonnull)message;
- (void)channel:(SBDBaseChannel * _Nonnull)channel didReceiveMention:(SBDBaseMessage * _Nonnull)message;
- (void)channelWasChanged:(SBDBaseChannel * _Nonnull)channel;
- (void)channel:(SBDGroupChannel * _Nonnull)channel didReceiveInvitation:(NSArray<SBDUser *> * _Nullable)invitees inviter:(SBDUser * _Nullable)inviter;
...
/// 3.0.171
@property (nonatomic) BOOL isBroadcast;
/// Determines the channel is exclusive channel or not. Default is <code>false</code>
/// since:
/// 4.0.0
@property (nonatomic) BOOL isExclusive;
...
/// 3.0.90
@property (nonatomic) BOOL isEphemeral;
@property (nonatomic) BOOL discoverable SWIFT_UNAVAILABLE_MSG("'discoverable' has been renamed to 'isDiscoverable'");
...
/// 3.0.136
@property (nonatomic) BOOL isDiscoverable;
@property (nonatomic) BOOL strict SWIFT_UNAVAILABLE_MSG("'strict' has been renamed to 'isStrict'");
...
@property (nonatomic, copy) NSString * _Nullable data;
@property (nonatomic, copy) NSString * _Nullable coverUrl SWIFT_UNAVAILABLE_MSG("'coverUrl' has been renamed to 'coverURL'");
...
@interface SBDGroupChannelCreateParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
/// Copies this object
/// \param zone optional <code>NSZone</code>
///
///
...
@interface SBDGroupChannelListQuery (SWIFT_EXTENSION(SendbirdChatSDK))
...
@interface SBDGroupChannelListQuery (SWIFT_EXTENSION(SendbirdChatSDK)) <Serializable>
/// Serializes this object into data
///
/// returns:
/// optioanal <code>Data</code> instance
...
enum SBDMyMemberStateFilter : NSInteger;
enum SBDGroupChannelListQueryType : NSInteger;
@class SBDGroupChannelListQuerySearchField;

@interface SBDGroupChannelListQuery (SWIFT_EXTENSION(SendbirdChatSDK))
/// Sets the member state filter.
@property (nonatomic, readonly) enum SBDMyMemberStateFilter memberStateFilter SWIFT_UNAVAILABLE_MSG("'memberStateFilter' has been renamed to 'myMemberStateFilter'");
...
///
- (void)setUserIdsIncludeFilter:(NSArray<NSString *> * _Nonnull)userIds queryType:(enum SBDGroupChannelListQueryType)queryType SWIFT_UNAVAILABLE_MSG("Use `GroupChannelListQueryParams`'s `setUserIdsIncludeFilter(_:queryType:)`");
...
///
- (void)setSearchFilter:(NSString * _Nonnull)query fields:(SBDGroupChannelListQuerySearchField * _Nonnull)fields SWIFT_UNAVAILABLE_MSG("Use `GroupChannelListQueryParams`'s `setSearchFilter(_:fields:)`");
/// Sets meta data filter
/// note:
...
///
- (void)setMetaDataFilterWithKey:(NSString * _Nonnull)key values:(NSArray<NSString *> * _Nonnull)values SWIFT_UNAVAILABLE_MSG("Use `GroupChannelListQueryParams`'s `setMetaDataFilter(_:values:)`");
/// Sets meta data filter
/// note:
...
///
- (void)setMetaDataFilterWithKey:(NSString * _Nonnull)key valueStartsWith:(NSString * _Nonnull)value SWIFT_UNAVAILABLE_MSG("Use `GroupChannelListQueryParams`'s `setMetaDataFilterWithKey(_:valueStartsWith:)`");
/// Specifies the number of results to return per call. (Default: 20)
- (void)setLimit:(NSUInteger)limit SWIFT_UNAVAILABLE_MSG("Use `GroupChannelListQueryParams`'s `limit`");
@end
...
/// since:
/// 3.0.182
@property (nonatomic, readonly) BOOL includeFrozenChannel;
/// Determines channel object of the list includes members list.
@property (nonatomic, readonly) BOOL includeMemberList;
...
@property (nonatomic, readonly) enum SBDGroupChannelListQueryType queryType;
/// Sets the member state filter.
@property (nonatomic, readonly) enum SBDMyMemberStateFilter myMemberStateFilter;
...
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable channelURLsFilter;
/// Sets to filter super channel. Default is <code>.all</code>
@property (nonatomic, readonly) enum SBDGroupChannelSuperChannelFilter superChannelFilter;
/// Sets to filter public channel.Default is <code>.all</code>
@property (nonatomic, readonly) enum SBDGroupChannelPublicChannelFilter publicChannelFilter;
/// Sets to filter channels by custom type that starts with.
@property (nonatomic, readonly, copy) NSString * _Nullable customTypeStartsWithFilter;
/// Sets the custom types filter. The custom types to search.
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable customTypesFilter;
/// Sets the filter with nickname substring.
/// Group channels whose members’ nicknames contain the filter are retruned by <code>loadNextPage:</code>.
@property (nonatomic, readonly, copy) NSString * _Nullable nicknameContainsFilter;
/// Sets the filter with nickname prefix.
/// Group channels whose members’ nicknames start with the filter are retruned by <code>loadNextPage:</code>.
@property (nonatomic, readonly, copy) NSString * _Nullable nicknameStartsWithFilter;
/// Sets the filter with nickname.
/// Group channels whose members’ nicknames match exactly with the filter are retruned by <code>loadNextPage:</code>.
@property (nonatomic, readonly, copy) NSString * _Nullable nicknameExactMatchFilter;
...
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable userIdsExactFilter;
...
@property (nonatomic, readonly, copy) NSString * _Nullable channelNameContainsFilter;
/// Sets to filter channels by the unread messages. The default value is <code>.all</code>.
/// since:
/// 3.0.113
@property (nonatomic, readonly) enum SBDUnreadChannelFilter unreadChannelFilter;
...
/// since:
/// 3.0.118
@property (nonatomic, readonly, copy) NSString * _Nullable metaDataOrderKeyFilter;
...
/// since:
/// 3.0.232
@property (nonatomic, readonly, copy) NSString * _Nullable metaDataValueStartsWithFilter;
/// Sets to filter channels by the hidden state. The default value is <code>ChannelHiddenStateFilter.unhiddenOnly</code>.
/// since:
/// 3.0.122
@property (nonatomic, readonly) enum SBDChannelHiddenStateFilter channelHiddenStateFilter;
...
@property (nonatomic, readonly) enum SBDGroupChannelListOrder order;
@end


SWIFT_CLASS_NAMED("GroupChannelListQueryParams")
@interface SBDGroupChannelListQueryParams : NSObject
/// Determines channel list includes empty channel. Default is <code>true</code>
@property (nonatomic) BOOL includeEmptyChannel;
/// Determines channel list includes frozen channel. Default is <code>true</code>
/// since:
...
/// Sets the member state filter.
@property (nonatomic) enum SBDMyMemberStateFilter myMemberStateFilter;
/// Sets <code>GroupChannel</code> URLs filter. <code>GroupChannel</code> list containing
/// only and exactly the passed <code>GroupChannel</code> URLs will be returned.
/// This does not cooperate with other filters.
...
/// Group channels whose members’ nicknames match exactly with the filter are retruned by <code>loadNextPage:</code>.
/// Since: 4.0.14
@property (nonatomic, copy) NSString * _Nullable nicknameExactMatchFilter;
/// Sets the filter with user IDs. The group channels which have the members that contain user
/// IDs are returned by <code>loadNextPage:</code>.
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable userIdsIncludeFilter;
/// Sets the filter with user IDs. The group channels which have the members that have user
...
/// returns:
/// An initialized params object.
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDGroupChannelListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
/// Sets the filter with user IDs.
/// The group channels which have the members that contain user IDs are returned by <code>loadNext:</code>.
/// \param userIds User IDs to search.
///
...
/// Filter exclusive group channel.
  SBDGroupChannelSuperChannelFilterExclusiveOnly = 4,
};
...
SWIFT_CLASS("_TtC15SendbirdChatSDK10HTTPClient")
...
@interface HTTPClient (SWIFT_EXTENSION(SendbirdChatSDK)) <NSURLSessionDataDelegate>
...
/// Loglevel
@property (nonatomic) enum SBDLogLevel logLevel;
/// Host app version
...
///
- (nonnull instancetype)initWithApplicationId:(NSString * _Nonnull)applicationId isLocalCachingEnabled:(BOOL)isLocalCachingEnabled logLevel:(enum SBDLogLevel)logLevel appVersion:(NSString * _Nullable)appVersion OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM_NAMED(NSInteger, SBDLogLevel, "LogLevel", open) {
  SBDLogLevelVerbose = 0,
  SBDLogLevelDebug = 1,
  SBDLogLevelInfo = 2,
  SBDLogLevelWarning = 3,
  SBDLogLevelError = 4,
  SBDLogLevelNone = 5,
};
...
/// Identifier for the user conforming to <code>Identifiable</code>
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
/// User ID. This has to be unique.
@property (nonatomic, readonly, copy) NSString * _Nonnull userId;
/// User nickname.
@property (nonatomic, copy) NSString * _Nonnull nickname;
@property (nonatomic, copy) NSString * _Nullable profileUrl SWIFT_UNAVAILABLE_MSG("'profileUrl' has been renamed to 'profileURL'");
/// Profile image url.
@property (nonatomic, readonly, copy) NSString * _Nullable profileURL;
@property (nonatomic, copy) NSString * _Nullable originalProfileUrl SWIFT_UNAVAILABLE_MSG("'originalProfileUrl' has been renamed to 'originalProfileURL'");
/// Original profile image url.
@property (nonatomic, readonly, copy) NSString * _Nullable originalProfileURL;
@property (nonatomic, copy) NSString * _Nullable plainProfileImageUrl SWIFT_UNAVAILABLE_MSG("'plainProfileImageUrl' has been renamed to 'plainProfileImageURL'");
...
@interface SBDMember (SWIFT_EXTENSION(SendbirdChatSDK))
/// Compares this object with given other object.
/// \param object <code>Any</code> instance
///
///
...
SWIFT_CLASS_NAMED("MemberListQuery")
@interface SBDMemberListQuery : NSObject
/// Boolean indicates there are more data to fetch
@property (nonatomic) BOOL hasNext;
/// Indicates the query is currently loading or not
@property (nonatomic) BOOL isLoading;
...
@interface SBDMemberListQuery (SWIFT_EXTENSION(SendbirdChatSDK))
...
/// since:
/// 3.0.89
@property (nonatomic, readonly) enum SBDGroupChannelOperatorFilter operatorFilter;
/// Sets a filter to query muted member list.
/// since:
/// 3.0.89
@property (nonatomic, readonly) enum SBDGroupChannelMutedMemberFilter mutedMemberFilter;
/// Sets a filter to query member list with member state.
@property (nonatomic, readonly) enum SBDMemberStateFilter memberStateFilter;
...
/// since:
/// 3.0.198
@property (nonatomic, readonly) enum SBDMemberListOrder order;
/// Specifies the number of results to return per call. (Default: 20)
@property (nonatomic, readonly) NSUInteger limit;
@end


SWIFT_CLASS_NAMED("MemberListQueryParams")
@interface SBDMemberListQueryParams : NSObject
/// Filters members of nickname that starts with.
/// since:
/// 3.0.102
@property (nonatomic, copy) NSString * _Nullable nicknameStartsWithFilter;
...
/// returns:
/// An initialized params object.
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDMemberListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end


@interface SBDMemberListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDMemberListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface SBDMessageCollection (SWIFT_EXTENSION(SendbirdChatSDK)) <SBDConnectionDelegate>
- (void)didSucceedReconnection;
- (void)didConnectWithUserId:(NSString * _Nonnull)userId;
@end


@interface SBDMessageCollection (SWIFT_EXTENSION(SendbirdChatSDK)) <ChannelEventDelegate>
- (void)channel:(SBDBaseChannel * _Nonnull)channel new:(SBDBaseMessage * _Nullable)new_;
- (void)channel:(SBDBaseChannel * _Nonnull)channel failed:(SBDBaseMessage * _Nonnull)failed source:(enum SBDCollectionEventSource)source;
- (void)channel:(SBDBaseChannel * _Nonnull)channel canceled:(SBDBaseMessage * _Nonnull)canceled;
- (void)channel:(SBDBaseChannel * _Nonnull)channel pending:(SBDBaseMessage * _Nonnull)pending;
...
@interface SBDMessageCollection (SWIFT_EXTENSION(SendbirdChatSDK)) <SBDGroupChannelDelegate>
- (void)channel:(SBDBaseChannel * _Nonnull)channel didReceiveMessage:(SBDBaseMessage * _Nonnull)message;
- (void)channel:(SBDBaseChannel * _Nonnull)channel didUpdateMessage:(SBDBaseMessage * _Nonnull)message;
- (void)channel:(SBDBaseChannel * _Nonnull)channel messageWasDeleted:(int64_t)messageId;
- (void)channel:(SBDBaseChannel * _Nonnull)channel updatedReaction:(SBDReactionEvent * _Nonnull)reactionEvent;
...
/// Restricts the search scope only to retrieve messages with the specified message type. Default is <code>.all</code>
...
@interface SBDMessageMetaArray (SWIFT_EXTENSION(SendbirdChatSDK))
/// Compares this object with given other object.
/// \param object <code>Any</code> instance
///
///
...
@interface SBDMessageMetaArray (SWIFT_EXTENSION(SendbirdChatSDK)) <Serializable>
/// Serializes this object into data
///
/// returns:
/// optioanal <code>Data</code> instance
...
SWIFT_CLASS_NAMED("MessageRequestState")
@interface SBDMessageRequestState : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface SBDMessageSearchQuery (SWIFT_EXTENSION(SendbirdChatSDK))
/// Channel url of the channel you want to set as a scope for the search.
@property (nonatomic, readonly, copy) NSString * _Nullable channelUrl SWIFT_UNAVAILABLE_MSG("'channelUrl' has been renamed to 'channelURL'");
@end


@interface SBDMessageSearchQuery (SWIFT_EXTENSION(SendbirdChatSDK)) <Serializable>
/// Serializes this object into data
///
/// returns:
/// optioanal <code>Data</code> instance
...
@property (nonatomic, readonly, copy) NSString * _Nullable channelCustomType;
...
@property (nonatomic, readonly) int64_t messageTimestampFrom;
/// Ending timestamp to search to. Default is 0
@property (nonatomic, readonly) int64_t messageTimestampTo;
/// The order method for the search. Default is <code>.score</code>
@property (nonatomic, readonly) enum SBDMessageSearchQueryOrder order;
/// Whether treat keyword field as advanced query or not
/// since:
/// 3.0.222
@property (nonatomic, readonly) BOOL advancedQuery;
/// Array of target fields in message’s data that will be searched with keyword
/// since:
/// 3.0.222
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable targetFields;
@end
...
SWIFT_CLASS_NAMED("MessageSearchQueryParams")
@interface SBDMessageSearchQueryParams : NSObject
/// Keyword to search for.
...
/// returns:
/// An initialized params object.
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDMessageSearchQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end


@interface SBDMessageSearchQueryParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDMessageSearchQueryParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
/// Indicates the status of the message that is scheduled.
  SBDMessageSendingStatusScheduled = 5,
};
...
/// since:
/// 3.1.0
SWIFT_CLASS("_TtC15SendbirdChatSDK11MessageSync")
...
@interface SBDMutedUserListQuery (SWIFT_EXTENSION(SendbirdChatSDK))
/// Specifies the number of results to return per call. (Default: 20)
@property (nonatomic, readonly) NSUInteger limit;
@end


SWIFT_CLASS_NAMED("MutedUserListQueryParams")
@interface SBDMutedUserListQueryParams : NSObject
/// Specifies the number of results to return per call. (Default: 20)
@property (nonatomic) NSUInteger limit;
/// Default constructor.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
/// returns:
/// An initialized params object.
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDMutedUserListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end


@interface SBDMutedUserListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDMutedUserListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end

/// Member state filter for group channel list query and group channel count
typedef SWIFT_ENUM_NAMED(NSInteger, SBDMyMemberStateFilter, "MyMemberStateFilter", open) {
/// Filter of all member states.
  SBDMyMemberStateFilterAll = 0,
/// Filter of joined state only.
  SBDMyMemberStateFilterJoinedOnly = 1,
/// Filter of invited state only. This contains <code>.invitedByFriend</code>and <code>invitedByNonFriend</code>.
  SBDMyMemberStateFilterInvitedOnly = 2,
/// Filter of invited by friend state only.
  SBDMyMemberStateFilterInvitedByFriend = 3,
/// Filter of invited by non-friend state only.
  SBDMyMemberStateFilterInvitedByNonFriend = 4,
};
...
@class SBDOpenChannelListQueryParams;
@class SBDParticipantListQuery;
@class SBDParticipantListQueryParams;
...
/// Creates a query instance for open channel list.
/// \param paramsBuilder The builder closure for setting <code>OpenChannelListQueryParams</code>.
///
///
/// returns:
/// The query instance for open channel list.
+ (SBDOpenChannelListQuery * _Nonnull)createOpenChannelListQueryWithParamsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDOpenChannelListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates a query instance for open channel list.
/// \param params The params object to change query condition.
///
///
/// returns:
/// The query instance for open channel list.
+ (SBDOpenChannelListQuery * _Nonnull)createOpenChannelListQueryWithParams:(SBDOpenChannelListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// ParticipantListQuery instance for the participant list of the channel instance.
+ (SBDParticipantListQuery * _Nonnull)createParticipantListQueryWithChannelURL:(NSString * _Nonnull)channelURL paramsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDParticipantListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates a query instance for getting participant list of the channel with the given channel URL.
/// \param channelURL URL of the channel to create the query with.
///
/// \param params The params object to change query condition.
...
/// returns:
/// ParticipantListQuery instance for the participant list of the channel instance.
+ (SBDParticipantListQuery * _Nonnull)createParticipantListQueryWithChannelURL:(NSString * _Nonnull)channelURL params:(SBDParticipantListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// <code>UserListQuery</code> instance for the participant list of the channel instance.
- (SBDParticipantListQuery * _Nullable)createParticipantListQueryWithParamsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDParticipantListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates a participant list query for this channel.
/// \param params The params object to change query condition.
///
///
/// returns:
/// <code>UserListQuery</code> instance for the participant list of the channel instance.
- (SBDParticipantListQuery * _Nullable)createParticipantListQueryWithParams:(SBDParticipantListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface SBDOpenChannelListQuery (SWIFT_EXTENSION(SendbirdChatSDK))
...
@property (nonatomic, readonly, copy) NSString * _Nullable channelURLFilter;
/// Sets the channel name filter.
@property (nonatomic, readonly, copy) NSString * _Nullable channelNameFilter;
/// Sets the custom type filter.
@property (nonatomic, readonly, copy) NSString * _Nullable customTypeFilter;
/// Specifies the number of results to return per call. (Default: 20)
@property (nonatomic, readonly) NSUInteger limit;
@end


SWIFT_CLASS_NAMED("OpenChannelListQueryParams")
@interface SBDOpenChannelListQueryParams : NSObject
/// Whether the result contains frozen channel or not. Default is <code>true</code>
/// since:
/// 3.0.182
@property (nonatomic) BOOL includeFrozenChannel;
...
/// returns:
/// An initialized params object.
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDOpenChannelListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end


@interface SBDOpenChannelListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDOpenChannelListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface SBDOperatorListQuery : NSObject <SBDUserListQuery>
/// Boolean indicates there are more data to fetch
@property (nonatomic) BOOL hasNext;
/// Indicates the query is currently loading or not
@property (nonatomic) BOOL isLoading;
...
@interface SBDOperatorListQuery (SWIFT_EXTENSION(SendbirdChatSDK))
/// Specifies the number of results to return per call. (Default: 20)
@property (nonatomic, readonly) NSUInteger limit;
@end


SWIFT_CLASS_NAMED("OperatorListQueryParams")
@interface SBDOperatorListQueryParams : NSObject
/// Specifies the number of results to return per call. (Default: 20)
@property (nonatomic) NSUInteger limit;
/// Default constructor.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
/// returns:
/// An initialized params object.
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDOperatorListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end


@interface SBDOperatorListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDOperatorListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface SBDParticipantListQuery : NSObject <SBDUserListQuery>
/// Boolean indicates there are more data to fetch
@property (nonatomic) BOOL hasNext;
/// Indicates the query is currently loading or not
@property (nonatomic) BOOL isLoading;
...
@interface SBDParticipantListQuery (SWIFT_EXTENSION(SendbirdChatSDK))
/// Specifies the number of results to return per call. (Default: 20)
@property (nonatomic, readonly) NSUInteger limit;
@end


SWIFT_CLASS_NAMED("ParticipantListQueryParams")
@interface SBDParticipantListQueryParams : NSObject
/// Specifies the number of results to return per call. (Default: 20)
@property (nonatomic) NSUInteger limit;
/// Default constructor.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
/// returns:
/// An initialized params object.
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDParticipantListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end


@interface SBDParticipantListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDParticipantListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
/// \param completionHandler completion block.
///
- (void)addOptionWithText:(NSString * _Nonnull)text channelType:(enum SBDChannelType)channelType channelURL:(NSString * _Nonnull)channelURL completionHandler:(void (^ _Nonnull)(SBDPoll * _Nullable, SBError * _Nullable))completionHandler;
/// Votes on this poll.
...
/// \param completionHandler completion block.
///
- (void)voteWithOptionIds:(NSArray<NSNumber *> * _Nonnull)optionIds channelType:(enum SBDChannelType)channelType channelURL:(NSString * _Nonnull)channelURL completionHandler:(void (^ _Nonnull)(SBDPoll * _Nullable, SBError * _Nullable))completionHandler;
@end


@interface SBDPoll (SWIFT_EXTENSION(SendbirdChatSDK))
/// Compares this object with given other object.
/// \param object <code>Any</code> instance
///
///
...
@interface SBDPollDetails (SWIFT_EXTENSION(SendbirdChatSDK))
/// Compares this object with given other object.
/// \param object <code>Any</code> instance
///
///
...
/// \param completionHandler completion block
///
+ (void)getWithPollId:(int64_t)pollId optionId:(int64_t)optionId channelType:(enum SBDChannelType)channelType channelURL:(NSString * _Nonnull)channelURL completionHandler:(void (^ _Nonnull)(SBDPollOption * _Nullable, SBError * _Nullable))completionHandler;
...
@interface SBDPollOption (SWIFT_EXTENSION(SendbirdChatSDK))
/// Compares this object with given other object.
/// \param object <code>Any</code> instance
///
///
...
@interface SBDPreviousMessageListQuery (SWIFT_EXTENSION(SendbirdChatSDK))
...
///
- (void)loadPreviousMessagesWithLimit:(NSUInteger)limit reverse:(BOOL)reverse completionHandler:(void (^ _Nonnull)(NSArray<SBDBaseMessage *> * _Nullable, SBError * _Nullable))completionHandler SWIFT_UNAVAILABLE_MSG("Use `loadNextPage(completionHandler:)` instead");
/// Fetches next page
/// \param completionHandler completion handler
///
- (void)loadWithCompletionHandler:(void (^ _Nullable)(NSArray<SBDBaseMessage *> * _Nullable, NSError * _Nullable))completionHandler SWIFT_UNAVAILABLE_MSG("'load' has been renamed to 'loadNextPageWithCompletionHandler:'");
@end
...
/// since:
/// 3.0.106
@property (nonatomic, readonly) enum SBDMessageTypeFilter messageTypeFilter;
...
/// since:
/// 3.0.106
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable senderUserIdsFilter;
...
@property (nonatomic, readonly) enum SBDReplyType replyType;
...
/// since:
/// 3.0.204
@property (nonatomic, readonly) BOOL showSubChannelMessagesOnly;
/// fetch limit
@property (nonatomic, readonly) NSUInteger limit;
@end


SWIFT_CLASS_NAMED("PreviousMessageListQueryParams")
@interface SBDPreviousMessageListQueryParams : NSObject
/// Sets the order of messages. If <code>true</code>, the latest message is the index 0. The default value is <code>false</code>.
/// since:
/// 3.0.106
@property (nonatomic) BOOL reverse;
...
/// returns:
/// An initialized params object.
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDPreviousMessageListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end


@interface SBDPreviousMessageListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDPreviousMessageListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface SBDPublicGroupChannelListQuery (SWIFT_EXTENSION(SendbirdChatSDK))
/// Sets meta data filter
/// note:
/// Using this method will reset <code>metaDataValueStartsWithFilter</code> property
/// \param key meta data key
...
/// \param values meta data values
///
- (void)setMetaDataFilterWithKey:(NSString * _Nonnull)key values:(NSArray<NSString *> * _Nonnull)values SWIFT_UNAVAILABLE_MSG("Use `PublicGroupChannelListQueryParams`'s `setMetaDataFilter(withKey:values)`");
/// Sets meta data filter
/// note:
/// Using this method will reset <code>metaDataValuesFilter</code> property
/// \param key meta data key
...
/// \param value meta data values that starts with
///
- (void)setMetaDataFilterWithKey:(NSString * _Nonnull)key valueStartsWith:(NSString * _Nonnull)value SWIFT_UNAVAILABLE_MSG("Use `PublicGroupChannelListQueryParams`'s `setMetaDataFilter(withKey:valueStartsWith)`");
@end
...
@property (nonatomic, readonly) enum SBDPublicGroupChannelListOrder order;
/// Sets to filter super channel. Default is <code>.all</code>
@property (nonatomic, readonly) enum SBDGroupChannelSuperChannelFilter superChannelFilter;
...
/// note:
/// This does not cooperate with other filters.
@property (nonatomic, readonly) enum SBDPublicGroupChannelMembershipFilter publicMembershipFilter;
/// Sets the custom types filter.
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable customTypesFilter;
/// Sets to filter channels by custom type that starts with.
@property (nonatomic, readonly, copy) NSString * _Nullable customTypeStartsWithFilter;
...
SWIFT_CLASS_NAMED("PublicGroupChannelListQueryParams")
@interface SBDPublicGroupChannelListQueryParams : NSObject
/// Determines channel list includes empty channel. Deafult is <code>true</code>
@property (nonatomic) BOOL includeEmptyChannel;
/// Determines channel list includes frozen channel. Default is <code>true</code>
/// since:
...
/// returns:
/// An initialized params object.
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDPublicGroupChannelListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
/// Sets meta data filter
/// note:
/// Using this method will reset <code>metaDataValueStartsWithFilter</code> property
/// \param key meta data key
...
@interface SBDPublicGroupChannelListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDPublicGroupChannelListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface SBDReaction (SWIFT_EXTENSION(SendbirdChatSDK)) <Mappable>
/// Initialize with json dictionary
- (nullable instancetype)initWithDictionary:(NSDictionary<NSString *, id> * _Nonnull)json SWIFT_METHOD_FAMILY(none) SWIFT_WARN_UNUSED_RESULT;
/// Converts the object into dictionary
- (NSDictionary<NSString *, id> * _Nonnull)_toDictionary SWIFT_WARN_UNUSED_RESULT;
...
@interface SBDReactionEvent (SWIFT_EXTENSION(SendbirdChatSDK)) <Mappable>
/// Initialize with json dictionary
- (nullable instancetype)initWithDictionary:(NSDictionary<NSString *, id> * _Nonnull)json SWIFT_METHOD_FAMILY(none) SWIFT_WARN_UNUSED_RESULT;
/// Converts the object into dictionary
- (NSDictionary<NSString *, id> * _Nonnull)_toDictionary SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC15SendbirdChatSDK7SBError")
...
SWIFT_PROTOCOL("_TtP15SendbirdChatSDK13SBLogReceiver_")
@protocol SBLogReceiver
- (void)logMessage:(NSString * _Nonnull)message;
@end


SWIFT_CLASS("_TtC15SendbirdChatSDK15SBRunloopThread")
...
SWIFT_CLASS("_TtC15SendbirdChatSDK7SBTimer")
@interface SBTimer : NSObject
- (void)abort;
- (void)stopWithCompletionHandler:(void (^ _Nullable)(NSError * _Nullable))completionHandler;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// since:
/// 4.0.0
SWIFT_CLASS_NAMED("ScheduledBaseMessageCreateParams")
@interface SBDScheduledBaseMessageCreateParams : NSObject
/// The time to send the message, in Unix milliseconds format. Term between current time and <code>scheduledAt</code> should be more than 5 minutes.
/// since:
/// 4.0.0
@property (nonatomic) int64_t scheduledAt;
/// The message data. The default value is nil.
/// since:
/// 4.0.0
@property (nonatomic, copy) NSString * _Nullable data;
/// The custom type of the message. The default value is <code>nil</code>.
/// since:
/// 4.0.0
@property (nonatomic, copy) NSString * _Nullable customType;
/// The push notification delivery option that determines how to deliver the push notification when sending
...
///
- (void)addMentionedUserIds:(NSArray<NSString *> * _Nonnull)userIds;
/// The push notification options for the Apple critical alert. The default value is <code>nil</code>.
/// since:
/// 4.0.0
@property (nonatomic, strong) SBDAppleCriticalAlertOptions * _Nullable appleCriticalAlertOptions;
- (nonnull instancetype)initWithScheduledAt:(int64_t)scheduledAt OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// since:
/// 4.0.0
SWIFT_CLASS_NAMED("ScheduledBaseMessageUpdateParams")
@interface SBDScheduledBaseMessageUpdateParams : NSObject
/// The time to send the message, in Unix milliseconds format. Term between current time and <code>scheduledAt</code> should be more than 5 minutes.
/// since:
/// 4.0.0
@property (nonatomic) int64_t scheduledAt;
...
/// since:
/// 4.0.0
/// \param mentionedUsers The list of users who will be mentioned.
///
- (void)setMentionedUsers:(NSArray<SBDUser *> * _Nonnull)mentionedUsers;
/// Adds user IDs for mention
/// since:
...
SWIFT_CLASS_NAMED("ScheduledFileMessageCreateParams")
@interface SBDScheduledFileMessageCreateParams : SBDScheduledBaseMessageCreateParams
/// The binary file data. <code>file</code> and <code>fileURL</code> cannot be set together.
@property (nonatomic, copy) NSData * _Nullable file;
/// The file URL. <code>file</code> and <code>fileURL</code> cannot be set together.
/// since:
/// 4.0.0
@property (nonatomic, copy) NSString * _Nullable fileURL;
/// The thumbnail sizes. This parameter is the array of <code>ThumbnailSize</code> instance and works for image file only.
/// since:
/// 4.0.0
@property (nonatomic, copy) NSArray<SBDThumbnailSize *> * _Nullable thumbnailSizes;
/// The file name.
...
/// returns:
/// An initialized file message params
- (nonnull instancetype)initWithScheduledAt:(int64_t)scheduledAt file:(NSData * _Nonnull)file OBJC_DESIGNATED_INITIALIZER;
...
/// returns:
/// An initialized file message params.
- (nonnull instancetype)initWithScheduledAt:(int64_t)scheduledAt fileURL:(NSString * _Nonnull)fileURL OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithScheduledAt:(int64_t)scheduledAt SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS_NAMED("ScheduledFileMessageUpdateParams")
@interface SBDScheduledFileMessageUpdateParams : SBDScheduledBaseMessageUpdateParams
/// The binary file data. <code>file</code> and <code>fileURL</code> cannot be set together.
/// since:
/// 4.0.0
@property (nonatomic, copy) NSData * _Nullable file;
...
/// since:
/// 4.0.0
SWIFT_CLASS_NAMED("ScheduledInfo")
@interface SBDScheduledInfo : NSObject
@property (nonatomic, readonly) int64_t scheduledMessageId;
@property (nonatomic, readonly) int64_t scheduledAt;
@property (nonatomic, strong) SBDScheduledBaseMessageCreateParams * _Nullable scheduledMessageParams;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface SBDScheduledInfo (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end

/// The order type for <code>ScheduledMessageListQuery</code>.
/// since:
/// 4.0.0
typedef SWIFT_ENUM_NAMED(NSInteger, SBDScheduledMessageListOrder, "ScheduledMessageListOrder", open) {
  SBDScheduledMessageListOrderCreatedAt = 0,
  SBDScheduledMessageListOrderScheduledAt = 1,
};
...
/// since:
/// 4.0.0
SWIFT_CLASS_NAMED("ScheduledMessageListQuery")
@interface SBDScheduledMessageListQuery : NSObject
...
@interface SBDScheduledMessageListQuery (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end

@class SBDScheduledStatusOptions;

@interface SBDScheduledMessageListQuery (SWIFT_EXTENSION(SendbirdChatSDK))
/// The maximum number of <code>BaseMessage</code>s per queried page. Default is <code>20</code>.
/// since:
/// 4.0.0
@property (nonatomic, readonly) NSInteger limit;
/// The order method for the search. Default is <code>.createdAt</code>
/// since:
/// 4.0.0
@property (nonatomic, readonly) enum SBDScheduledMessageListOrder order;
/// A Boolean value that indicates whether to reverse the queried result list. Default is <code>false</code>.
/// since:
/// 4.0.0
@property (nonatomic, readonly) BOOL reverse;
...
/// since:
/// 4.0.0
@property (nonatomic, readonly, strong) SBDScheduledStatusOptions * _Nonnull scheduledStatusOptions;
/// Restricts the search scope only to retrieve messages with the specified message type. Default is <code>.all</code>.
/// since:
/// 4.0.0
@property (nonatomic, readonly) enum SBDMessageTypeFilter messageTypeFilter;
...
SWIFT_CLASS_NAMED("ScheduledMessageListQueryParams")
@interface SBDScheduledMessageListQueryParams : NSObject
/// The maximum number of <code>BaseMessage</code>s per queried page. Default is <code>20</code>.
/// since:
/// 4.0.0
...
/// since:
/// 4.0.0
@property (nonatomic) enum SBDScheduledMessageListOrder order;
/// A Boolean value that indicates whether to reverse the queried result list. Default is <code>false</code>.
/// since:
/// 4.0.0
@property (nonatomic) BOOL reverse;
...
/// since:
/// 4.0.0
@property (nonatomic, strong) SBDScheduledStatusOptions * _Nonnull scheduledStatusOptions;
/// Restricts the search scope only to retrieve messages with the specified message type. Default is <code>.all</code>.
/// since:
/// 4.0.0
@property (nonatomic) enum SBDMessageTypeFilter messageTypeFilter;
...
/// returns:
/// An initialized params object.
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDScheduledMessageListQueryParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end


@interface SBDScheduledMessageListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDScheduledMessageListQueryParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
/// since:
/// 4.0.0
SWIFT_CLASS_NAMED("ScheduledMessageRetrievalParams")
@interface SBDScheduledMessageRetrievalParams : NSObject
/// Specifies the URL of the channel to retrieve the message.
/// since:
/// 4.0.0
@property (nonatomic, readonly, copy) NSString * _Nonnull channelURL;
...
- (nonnull instancetype)initWithChannelURL:(NSString * _Nonnull)channelURL scheduledMessageId:(int64_t)scheduledMessageId OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM_NAMED(NSInteger, SBDScheduledStatus, "ScheduledStatus", open) {
  SBDScheduledStatusPending = 0,
  SBDScheduledStatusSent = 1,
  SBDScheduledStatusFailed = 2,
  SBDScheduledStatusCanceled = 3,
};


SWIFT_CLASS_NAMED("ScheduledStatusOptions")
@interface SBDScheduledStatusOptions : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) SBDScheduledStatusOptions * _Nonnull pending;)
+ (SBDScheduledStatusOptions * _Nonnull)pending SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) SBDScheduledStatusOptions * _Nonnull sent;)
+ (SBDScheduledStatusOptions * _Nonnull)sent SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) SBDScheduledStatusOptions * _Nonnull failed;)
+ (SBDScheduledStatusOptions * _Nonnull)failed SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) SBDScheduledStatusOptions * _Nonnull canceled;)
+ (SBDScheduledStatusOptions * _Nonnull)canceled SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, readonly) NSInteger rawValue;
- (nonnull instancetype)initWithAbilitiesToUnion:(NSArray<SBDScheduledStatusOptions *> * _Nonnull)abilitiesToUnion;
/// hash
@property (nonatomic, readonly) NSUInteger hash;
/// Compares this object with given other object.
/// \param object <code>Any</code> instance
...
@interface SBDScheduledUserMessageCreateParams : SBDScheduledBaseMessageCreateParams
/// The message text.
/// since:
/// 4.0.0
...
/// since:
/// 4.0.0
@property (nonatomic, copy) NSArray<NSString *> * _Nullable translationTargetLanguages;
/// Initializes and returns a params object for creating a scheduled user message.
/// \param scheduledAt The time to send the message, in Unix milliseconds format. Term between current time and <code>scheduledAt</code> should be more than 5 minutes.
///
...
- (nonnull instancetype)initWithScheduledAt:(int64_t)scheduledAt message:(NSString * _Nonnull)message OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithScheduledAt:(int64_t)scheduledAt SWIFT_UNAVAILABLE;
@end
...
/// since:
/// 4.0.0
SWIFT_CLASS_NAMED("ScheduledUserMessageUpdateParams")
@interface SBDScheduledUserMessageUpdateParams : SBDScheduledBaseMessageUpdateParams
/// The message text.
/// since:
/// 4.0.0
...
@class SBDTotalScheduledMessageCountParams;
...
SWIFT_CLASS("_TtC15SendbirdChatSDK12SendbirdChat")
...
/// Synchronously initializes <code>SendbirdChat</code> singleton instance with Sendbird Application ID.
/// The Application ID is on Sendbird dashboard. This method has to be run first in order to user Sendbird.
/// since:
/// 4.0.15
/// \param params <code>InitParams</code> object
...
///
/// returns:
/// <code>nil</code> if the applicationId is set, otherwise <code>SBError</code>
+ (SBError * _Nullable)initializeSynchronouslyWithParams:(SBDInitParams * _Nonnull)params;
...
/// since:
/// 3.0.120
/// \param paramsBuilder The builder closure for setting <code>ApplicationUserListQueryParams</code>.
///
///
/// returns:
/// <code>ApplicationUserListQuery</code> instance.
+ (SBDApplicationUserListQuery * _Nonnull)createApplicationUserListQueryWithParamsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDApplicationUserListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates <code>ApplicationUserListQuery</code> instance for getting a list of all users of this application.
/// since:
/// 3.0.120
/// \param params <code>ApplicationUserListQueryParams</code> instance.
///
///
/// returns:
/// <code>ApplicationUserListQuery</code> instance.
+ (SBDApplicationUserListQuery * _Nonnull)createApplicationUserListQueryWithParams:(SBDApplicationUserListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
...
/// Creates <code>BlockedUserListQuery</code> instance for getting a list of blocked users by the current user.
/// \param paramsBuilder The builder closure for setting <code>BlockedUserListQueryParams</code>.
///
///
/// returns:
/// <code>BlockedUserListQuery</code> instance.
+ (SBDBlockedUserListQuery * _Nonnull)createBlockedUserListQueryWithParamsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDBlockedUserListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates <code>BlockedUserListQuery</code> instance for getting a list of blocked users by the current user.
/// \param params <code>BlockedUserListQueryParams</code> instance.
///
///
/// returns:
/// <code>BlockedUserListQuery</code> instance.
+ (SBDBlockedUserListQuery * _Nonnull)createBlockedUserListQueryWithParams:(SBDBlockedUserListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
/// Creates <code>MessageSearchQuery</code> instance for message search
/// since:
/// 4.0.0
/// \param paramsBuilder The builder closure for setting <code>MessageSearchQueryParams</code>
///
///
/// returns:
/// <code>MessageSearchQuery</code> instance
+ (SBDMessageSearchQuery * _Nonnull)createMessageSearchQueryWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDMessageSearchQueryParams * _Nonnull))builder SWIFT_WARN_UNUSED_RESULT;
/// Creates <code>MessageSearchQuery</code> instance for message search
/// since:
/// 4.0.0
/// \param params The params object to change query condition.
...
/// returns:
/// <code>MessageSearchQuery</code> instance
+ (SBDMessageSearchQuery * _Nonnull)createMessageSearchQueryWithParams:(SBDMessageSearchQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
/// Adds a <code>ConnectionDelegate</code>.
/// since:
/// 4.0.12
...
/// Adds a <code>BaseChannelDelegate</code>.
/// since:
/// 4.0.12
...
/// since:
/// 4.0.0
/// \param paramsBuilder The builder closure for setting <code>FriendListQueryParams</code>.
///
///
/// returns:
/// <code>FriendListQuery</code> instance
+ (SBDFriendListQuery * _Nonnull)createFriendListQueryWithParamsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDFriendListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates <code>FriendListQuery</code> instance for friend list
/// since:
/// 4.0.0
/// \param params The params object to change query condition.
...
/// returns:
/// <code>FriendListQuery</code> instance
+ (SBDFriendListQuery * _Nonnull)createFriendListQueryWithParams:(SBDFriendListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
...
/// since:
/// 3.0.116
/// \param myMemberStateFilter The member state of the current user in the channels that are counted.
///
/// \param completionHandler The handler block to execute.
///
+ (void)getGroupChannelCountWithMyMemberStateFilter:(enum SBDMyMemberStateFilter)myMemberStateFilter completionHandler:(void (^ _Nonnull)(NSUInteger, SBError * _Nullable))completionHandler;
...
/// returns:
/// Log level.
+ (enum SBDLogLevel)getLogLevel SWIFT_WARN_UNUSED_RESULT;
/// Sets the log level. The log level is defined by <code>LogLevel</code>.
/// \param logLevel Log level.
///
+ (void)setLogLevel:(enum SBDLogLevel)logLevel;
...
///
+ (SBDMessageCollection * _Nonnull)createMessageCollectionWithChannel:(SBDGroupChannel * _Nonnull)channel startingPoint:(int64_t)startingPoint params:(SBDMessageListParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
...
/// \param completionHandler completion 
///
+ (void)clearCachedMessagesWithChannelURL:(NSString * _Nonnull)channelURL completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler;
...
/// since:
/// 4.0.0
/// \param params The object that contains a set of options to get scheduled messages.
///
/// \param completionHandler The handler block to be executed after the total scheduled message count in the channel is fetched or an error occurs.
///
+ (void)getTotalScheduledMessageCountWithParams:(SBDTotalScheduledMessageCountParams * _Nonnull)params completionHandler:(void (^ _Nonnull)(NSUInteger, SBError * _Nullable))completionHandler;
/// Creates <code>ScheduledMessageListQuery</code> for getting the list of scheduled messages.
/// since:
/// 4.0.0
/// \param channelURL The channel URL. If <code>channelURL</code> is nil, you will get scheduled messages for all channels.
///
///
/// returns:
/// The scheduled message list query object.
+ (SBDScheduledMessageListQuery * _Nonnull)createScheduledMessageListQueryWithChannelURL:(NSString * _Nullable)channelURL SWIFT_WARN_UNUSED_RESULT;
/// Creates <code>ScheduledMessageListQuery</code> for getting the list of scheduled messages.
/// since:
/// 4.0.0
/// \param channelURL The channel URL. If <code>channelURL</code> is nil, you will get scheduled messages for all channels.
///
/// \param paramsBuilder The builder closure for setting <code>ScheduledMessageListQueryParams</code>.
///
///
/// returns:
/// The scheduled message list query object.
+ (SBDScheduledMessageListQuery * _Nonnull)createScheduledMessageListQueryWithChannelURL:(NSString * _Nullable)channelURL paramsBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDScheduledMessageListQueryParams * _Nonnull))paramsBuilder SWIFT_WARN_UNUSED_RESULT;
/// Creates <code>ScheduledMessageListQuery</code> for getting the list of scheduled messages.
/// since:
/// 4.0.0
/// \param channelURL The channel URL. If <code>channelURL</code> is nil, you will get scheduled messages for all channels.
...
/// returns:
/// The scheduled message list query object.
+ (SBDScheduledMessageListQuery * _Nonnull)createScheduledMessageListQueryWithChannelURL:(NSString * _Nullable)channelURL params:(SBDScheduledMessageListQueryParams * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy, getter=default) NSString * _Nonnull default_;)
+ (NSString * _Nonnull)default SWIFT_WARN_UNUSED_RESULT;
...
@interface SendbirdChat (SWIFT_EXTENSION(SendbirdChatSDK))
+ (void)getChannelCountWith:(enum SBDMemberStateFilter)with completionHandler:(SWIFT_NOESCAPE void (^ _Nonnull)(NSUInteger, SBError * _Nullable))completionHandler SWIFT_UNAVAILABLE_MSG("'getChannelCount' has been renamed to 'getGroupChannelCount(memberStateFilter:completionHandler:)'");
+ (void)getMyGroupChannelChangeLogsByTimestamp:(int64_t)byTimestamp params:(SBDGroupChannelChangeLogsParams * _Nullable)params completionHandler:(SWIFT_NOESCAPE void (^ _Nonnull)(NSArray<SBDGroupChannel *> * _Nullable, NSArray<NSString *> * _Nullable, BOOL, NSString * _Nullable, SBError * _Nullable))completionHandler SWIFT_UNAVAILABLE_MSG("'getMyGroupChannelChangeLogs' has been renamed to 'getMyGroupChannelChangeLogsWithTimestamp:params:completionHandler:'");
+ (void)getMyGroupChannelChangeLogsByToken:(NSString * _Nullable)byToken params:(SBDGroupChannelChangeLogsParams * _Nullable)params completionHandler:(SWIFT_NOESCAPE void (^ _Nonnull)(NSArray<SBDGroupChannel *> * _Nullable, NSArray<NSString *> * _Nullable, BOOL, NSString * _Nullable, SBError * _Nullable))completionHandler SWIFT_UNAVAILABLE_MSG("'getMyGroupChannelChangeLogs' has been renamed to 'getMyGroupChannelChangeLogsWithToken:params:completionHandler:'");
+ (BOOL)isUsingLocalCaching SWIFT_WARN_UNUSED_RESULT SWIFT_UNAVAILABLE_MSG("'isUsingLocalCaching' has been renamed to 'isLocalCachingEnabled'");
+ (NSData * _Nullable)getPendingPushKitToken SWIFT_WARN_UNUSED_RESULT SWIFT_UNAVAILABLE_MSG("`getPendingPushKitToken` has been removed.");
+ (void)registerDevicePushKitToken:(NSData * _Nonnull)devToken unique:(BOOL)unique completionHandler:(void (^ _Nullable)(enum SBDPushTokenRegistrationStatus, SBError * _Nullable))completionHandler SWIFT_UNAVAILABLE_MSG("`registerDevicePushKitToken(_:unique:completionHandler:)` has been removed.");
+ (void)updateCurrentUserInfoWithNickname:(NSString * _Nullable)nickname profileUrl:(NSString * _Nullable)profileUrl completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler SWIFT_UNAVAILABLE_MSG("'updateCurrentUserInfo' has been renamed to 'updateCurrentUserInfoWithParams:progressHandler:completionHandler:'");
+ (void)updateCurrentUserInfoWithNickname:(NSString * _Nullable)nickname profileImage:(NSData * _Nullable)profileImage completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler SWIFT_UNAVAILABLE_MSG("'updateCurrentUserInfo' has been renamed to 'updateCurrentUserInfoWithParams:progressHandler:completionHandler:'");
+ (void)updateCurrentUserInfoWithNickname:(NSString * _Nullable)nickname profileImage:(NSData * _Nullable)profileImage progressHandler:(void (^ _Nullable)(int64_t, int64_t, int64_t))progressHandler completionHandler:(void (^ _Nullable)(SBError * _Nullable))completionHandler SWIFT_UNAVAILABLE_MSG("'updateCurrentUserInfo' has been renamed to 'updateCurrentUserInfoWithParams:progressHandler:completionHandler:'");
...
SWIFT_CLASS("_TtC15SendbirdChatSDK19SendbirdChatOptions")
@interface SendbirdChatOptions : NSObject
+ (BOOL)useMemberAsMessageSender SWIFT_WARN_UNUSED_RESULT SWIFT_UNAVAILABLE_MSG("'useMemberAsMessageSender' has been renamed to 'useMemberInfoInMessage'");
...
+ (BOOL)useMemberInfoInMessage SWIFT_WARN_UNUSED_RESULT;
+ (void)setUseMemberAsMessageSender:(BOOL)value SWIFT_UNAVAILABLE_MSG("'setUseMemberAsMessageSender' has been renamed to 'setMemberInfoInMessage()'");
...
///
+ (void)setMemberInfoInMessage:(BOOL)value;
...
@interface SBDSender (SWIFT_EXTENSION(SendbirdChatSDK))
/// Compares this object with given other object.
/// \param object <code>Any</code> instance
///
///
...
SWIFT_CLASS("_TtC15SendbirdChatSDK22SessionWebSocketEngine") SWIFT_AVAILABILITY(ios,introduced=13)
...
@interface SessionWebSocketEngine (SWIFT_EXTENSION(SendbirdChatSDK)) <NSURLSessionDataDelegate, NSURLSessionWebSocketDelegate>
...
SWIFT_CLASS("_TtC15SendbirdChatSDK16StarscreamEngine")
...
/// The number of messages to retrieve that were sent before the specified timestamp or message ID. Default is <code>0</code>.
@property (nonatomic) NSInteger previousResultSize;
/// The number of messages to retrieve that were sent after the specified timestamp or message ID. Default is <code>0</code>.
@property (nonatomic) NSInteger nextResultSize;
/// Determines whether to include the messages with the matching timestamp or message ID in the results. Default is <code>false</code>.
@property (nonatomic) BOOL isInclusive;
/// Determines whether to sort the retrieved messages in reverse order. If <code>false</code>, the results are in ascending order. Default is <code>false</code>.
...
/// Determines whether to include the reactions to the messages in the results. Default is <code>false</code>.
@property (nonatomic) BOOL includeReactions;
/// Determines whether to include the parent message information to the message in the results. Default is <code>false</code>.
/// <ul>
///   <li>
///     Since 3.0.236
///   </li>
...
@interface SBDThumbnail (SWIFT_EXTENSION(SendbirdChatSDK))
/// Compares this object with given other object.
/// \param object <code>Any</code> instance
///
///
...
@interface SBDThumbnail (SWIFT_EXTENSION(SendbirdChatSDK)) <Serializable>
/// Serializes this object into data
///
/// returns:
/// optioanal <code>Data</code> instance
...
/// since:
/// 4.0.0
SWIFT_CLASS_NAMED("TotalScheduledMessageCountParams")
@interface SBDTotalScheduledMessageCountParams : NSObject
/// Channel URL which has this message.
/// since:
/// 4.0.0
@property (nonatomic, readonly, copy) NSString * _Nonnull channelURL;
...
@interface SBDUnreadItemCount (SWIFT_EXTENSION(SendbirdChatSDK)) <Mappable>
/// Initialize with json dictionary
- (nullable instancetype)initWithDictionary:(NSDictionary<NSString *, id> * _Nonnull)json SWIFT_METHOD_FAMILY(none) SWIFT_WARN_UNUSED_RESULT;
/// Converts the object into dictionary
- (NSDictionary<NSString *, id> * _Nonnull)_toDictionary SWIFT_WARN_UNUSED_RESULT;
...
@interface SBDUser (SWIFT_EXTENSION(SendbirdChatSDK)) <Serializable>
/// Serializes this object into data
///
/// returns:
/// optioanal <code>Data</code> instance
...
@interface SBDUser (SWIFT_EXTENSION(SendbirdChatSDK))
...
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * _Nonnull translations;
...
/// since:
/// 4.0.0
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull translationTargetLanguages;
@property (nonatomic, strong) SBDMessageRequestState * _Nullable requestState SWIFT_UNAVAILABLE_MSG("This property has been removed.");
...
- (SBDUserMessageCreateParams * _Nullable)getUserMessageParams SWIFT_WARN_UNUSED_RESULT;
@end
...
@property (nonatomic, copy) NSString * _Nullable profileImageUrl SWIFT_UNAVAILABLE_MSG("'profileImageUrl' has been renamed to 'profileImageURL'");
...
SWIFT_CLASS("_TtC15SendbirdChatSDK9WebSocket")
